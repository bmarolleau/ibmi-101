...
> **Rule of thumb:** On IBM i, *everything is an object*. Until that clicks, many behaviours will seem mysterious.
...
- [14. Evolution Timeline — 3 Eras, Fortra Survey, What Still Looks Like](#14-evolution-timeline)
...
## 5b. Introduction to IBM i Application Modernization
...
### Three eras of IBM i development
...
### What "still doing this" looks like
...
> The goal is not to rewrite everything — it is to **enable the next generation of developers** to work with IBM i using tools they already know, while protecting the existing business logic that runs in production.
...
| ILE RPG Programmer's Guide | https://www.ibm.com/docs/en/i/7.6.0?topic=rpg-ile-programmers-guide |
| IBM i 7.5 — Program Cycle | https://www.ibm.com/docs/en/i/7.5?topic=logic-program-cycle |
| File Description Specifications | https://www.ibm.com/docs/en/i/7.4.0?topic=specifications-file-description |
| RPG IV Specifications (7.5) | https://www.ibm.com/docs/en/i/7.5.0?topic=language-rpg-iv-specifications |
| DDS for database files (7.5) | https://www.ibm.com/docs/en/i/7.5.0?topic=files-describing-database-using-dds |
| Db2 for i SQL Reference | https://www.ibm.com/docs/en/i/7.6.0?topic=reference-db2-i-sql |
| IBM i CL Reference | https://www.ibm.com/docs/en/i/7.6.0?topic=reference-control-language |
